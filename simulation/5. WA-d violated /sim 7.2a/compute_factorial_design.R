# sim 7.2a : misspecification of AA
...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  AvgTau_tw_ratio = c(0.8, 0.9, 1, 1.1, 1.2),
...
# taut
SD$AvgTau_w <- SD$AvgTau_t / SD$AvgTau_tw_ratio
...
summary(SD)
dim(SD)
saveRDS(SD, file = "simulation/5. WA-d violated /sim 7.2a/Simulation_design.RDS")
