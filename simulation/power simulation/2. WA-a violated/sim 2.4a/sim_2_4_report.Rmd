...
```{r}
source("~/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_4/functions_util.R")
# read simulation design 
SD <- readRDS("~/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_4/Simulation_design.RDS")
n_seed = 3 
nsim = 500
truth_hypothesis = "H1"
dim(SD)
...
# 3. Make plots and tables ------------------------------------------------
    ...
    result <- readRDS(paste0("result_2_4a_df_collected_nsim", nsim, ".RDS"))
    ...
    xlab(TeX(r'($\theta_2^w$)')) +
    ylab("power") +
    #ggtitle(TeX(r'($sMEE_k^*(t)$: Linear; $\theta_2^* = 0)')) +
...
```{r eval=FALSE}
source("~/Documents//Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_3/functions_util.R")
# read simulation design 
SD <- readRDS("~/Documents//Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_3/Simulation_design.RDS")
n_seed = 4 
nsim = 500

result_list = list()
for (isim in 1:n_seed) {
  fileName = paste("results_sim_2_3_setting_",isim,"_",nsim,".RDS",sep = "")
  res <- readRDS(paste0(fileName))
  result_list <- c(result_list, res)
}
length(result_list)
