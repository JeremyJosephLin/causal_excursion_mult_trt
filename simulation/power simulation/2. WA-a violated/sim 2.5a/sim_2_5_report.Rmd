...
```{r eval=FALSE}
source("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_5/functions_util.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_5/Simulation_design.RDS")
n_seed = 6 
nsim = 500

result_list = list()
for (isim in 1:n_seed) {
  fileName = paste("results_sim_2_5a_setting_",isim,"_",nsim,".RDS",sep = "")
...
for (isetting in 1:setting) {
  ...
  saveRDS(result_df_collected, file = paste0("result_2_5a_df_collected_nsim", nsim, ".RDS"))
  saveRDS(result_list_collected, file = paste0("result_list_2_5a_collected_nsim", nsim, ".RDS"))
  write.csv(result_df_collected, file = paste0("result_2_5a_df_collected_nsim", nsim, ".csv"))
...
# 3. Make plots and tables ------------------------------------------------
    ...
    result <- readRDS(paste0("result_2_5a_df_collected_nsim", nsim, ".RDS"))
    ...
    # this two line of code is used to remove the legend in the graph
...
ggsave(paste0("figure 3 - power.pdf"), width = 12, height = 8)
```
...
ggsave(paste0("figure 3_v2 - power.pdf"), width = 12, height = 6)
```
