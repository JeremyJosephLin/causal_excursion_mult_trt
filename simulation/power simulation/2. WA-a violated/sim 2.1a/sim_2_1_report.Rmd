...
```{r}
source("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_1/functions_util.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_1/Simulation_design.RDS")
n_seed = 1 
nsim = 500
...
for (i in 1:setting) {
  ...
  for (isim in 1:n_seed) {
    fileName = paste("results_sim_2_1_setting_",i,"_",isim,".RDS",sep = "")
...
# 3. Make plots and tables ------------------------------------------------
    ...
    result <- readRDS(paste0("result_2_1a_df_collected_nsim", nsim, ".RDS"))
    ...
    # added delta_ATE
    result$delta_ATE <- result$ATE2_t - result$ATE1_t 
...
p2
ggsave(paste0("viol1_sim1_power.pdf"), width = 12, height = 8)
...
p3
ggsave(paste0("viol1_sim1_power_v2.pdf"), width = 12, height = 6)
