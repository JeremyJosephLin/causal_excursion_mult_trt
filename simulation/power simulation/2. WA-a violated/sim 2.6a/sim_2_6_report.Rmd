...
```{r}
source("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_6/functions_util.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_1/hpc_script/sim_2_6/Simulation_design.RDS")
n_seed = 3 
nsim = 500
truth_hypothesis = "H1"
dim(SD)
...
for (isim in 1:n_seed) {
  fileName = paste("results_sim_2_6_setting_",isim,"_",nsim,".RDS",sep = "")
...
# 3. Make plots and tables ------------------------------------------------
    ...
    ggplot(aes(x = ft_t_theta2, y = power_adj, linetype = factor(factor(ft_t_theta)),
...
ggsave(paste0("figure 2.6 - power.pdf"), width = 12, height = 8)
```
...
ggsave(paste0("figure 2.6_v2 - power.pdf"), width = 12, height = 6)
```
