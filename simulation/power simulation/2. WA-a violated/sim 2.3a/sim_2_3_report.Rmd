...
# 3. Make plots and tables ------------------------------------------------
    ...
    result <- readRDS(paste0("result_2_3a_df_collected_nsim", nsim, ".RDS"))
    ...
    p2 <- result %>%
      ...
      scale_color_discrete(
        ...
        labels = c(
          TeX(r'($\Delta ATE^* = \Delta ATE^w = 0.3$, $AEO^* = AEO^w = 0.2$)'),
      ...
      theme_bw() +
      myggfont() +
      guides(linetype = guide_legend(order = 1), # Line type legend first
             color = guide_legend(order = 2)) +    # Color legend second)
      theme(legend.text.align = 0,
            plot.title = element_text(hjust = 0.5))
    p2
    
ggsave(paste0("viol1_sim3 - power.pdf"), width = 12, height = 8)
```
...
ggsave(paste0("viol1_sim3_v2 - power.pdf"), width = 12, height = 6)
```
