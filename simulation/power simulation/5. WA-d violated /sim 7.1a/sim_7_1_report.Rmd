...
```{r}
source("~/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_4/sim_7_1/functions_util.R")
# read simulation design 
SD <- readRDS("~/Research/causal_excursion_mult_trt/simulation_results/Power Simulation/viol_4/sim_7_1/Simulation_design.RDS")
n_seed = 5 
nsim = 500
truth_hypothesis = "H1"
dim(SD)
...
for (isim in 1:n_seed) {
  fileName = paste("results_sim_7_1a_setting_",isim,"_",nsim,".RDS",sep = "")
...
ggsave(paste0("figure 7_1 - power.pdf"), width = 10, height = 6)
