...
SD <- readRDS("simulation/all working assumptions hold/Simulation_design.RDS")
...
# these codes are use for running  the code in the cluster
# source("functions_util.R")
# SD <- readRDS("Simulation_design.RDS")
...
outName <- paste("results_setting_",i,"_",nSeed,".RDS",sep = "")
