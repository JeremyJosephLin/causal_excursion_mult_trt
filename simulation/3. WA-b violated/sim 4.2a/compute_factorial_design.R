# misspecification of gt, linear true eo, constant working eo 
rm(list = ls())
...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  ft_t_theta = c(0),
                  ft_t_theta2 = 0,
                  gt_t_shape = c("linear_theta"),
                  gt_t_theta = seq(from = -1, to = 1, by = 0.05), 
...
summary(SD)
dim(SD)
saveRDS(SD, file = "simulation/3. WA-b violated/sim 4.2a/Simulation_design.RDS")
