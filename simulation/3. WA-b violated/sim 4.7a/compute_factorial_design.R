# sim 4.7a : misspecification of gt, added weekend effect
rm(list = ls())
...
summary(SD)
dim(SD)
saveRDS(SD, file = "simulation/3. WA-b violated/sim 4.7a/Simulation_design.RDS")
