# simulation of misspecification of AEO
rm(list = ls())
...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  ASPNC_tw_ratio = seq(from = 0.8, to = 1.2, by = 0.025),
...
SD$ASPNC_w <- SD$ASPNC_t / SD$ASPNC_tw_ratio
# ft
...
summary(SD)
dim(SD)
saveRDS(SD, file = "simulation/3. WA-b violated/sim 4.1a/Simulation_design.RDS")
