...
for (i in 1:nrow(SD)) {
  ...
  ## taut_w
  taut_w <- construct_taut_theta(m, SD$AvgTau_w[i], SD$tau_w_shape[i], theta = SD$tau_t_theta[i])
...
summary(SD)
dim(SD)
saveRDS(SD, file = "n_vs_theta_Tau.RDS")
